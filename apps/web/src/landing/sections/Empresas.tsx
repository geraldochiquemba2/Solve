      ...
      >
        <div className="marquee-track">
          {doubled.map((name, i) => (
            ...
            >
              {/* Logo text pill */}
              <div className="px-6 py-3 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 group-hover:border-[#042251]/40 group-hover:bg-[#042251]/5 transition-all duration-300">
              ...
              {/* Separator dot */}
              <span className="w-1 h-1 bg-[#042251]/30 flex-shrink-0" />
            </div>
          ))}
        </div>
      </div>
