...
export default function BrandShowcase() {
  return (
    <section className="py-24 bg-white dark:bg-zinc-950 border-y border-zinc-200 dark:border-zinc-800 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(4,34,81,0.03)_0%,transparent_70%)]" />
      ...
      <div className="container-custom relative z-10 flex flex-col items-center justify-center text-center">
        ...
        >
          <img 
            src={solveAccessLogo} 
            alt="Solve Access" 
            className="w-48 md:w-64 h-auto mx-auto mb-8 drop-shadow-[0_0_30px_rgba(4,34,81,0.15)]"
            style={{ backgroundColor: '#fff', borderRadius: 12, padding: '8px 20px' }}
          />
